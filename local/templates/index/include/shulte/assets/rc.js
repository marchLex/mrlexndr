...
just.RandomColor = (function() {
    ...
    Color.prototype.refresh = function() {
        var randomNumber = function(min, max) {
			...
			arr1 = randomNumber(0,1),
			arr2 = randomNumber(0,1),
			arr3 = randomNumber(0,1),
            r = randomNumber(options.r[arr1][0], options.r[arr1][1]),
            g = randomNumber(options.g[arr2][0], options.g[arr2][1]),
            b = randomNumber(options.b[arr3][0], options.b[arr3][1]),
